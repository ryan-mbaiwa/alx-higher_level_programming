...
Project done during Full Stack Software Engineering studies at **alx software engineering **. It aims to learn about if/else statements, loops, range and functions in Python.
